...
btnSearchWeather.addEventListener("click", async () => {
  ...
  console.log(tomorrowWeather.list);
  ...
  dayOne.innerText = tomorrowWeather.list[7].dt_txt;
  dayOneIcon.src = `http://openweathermap.org/img/wn/${tomorrowWeather.list[0].weather[0].icon}.png`;
  dayOneTemp.innerText = `Temperature will be ${tomorrowWeather.list[7].main.temp} degree`;
});
